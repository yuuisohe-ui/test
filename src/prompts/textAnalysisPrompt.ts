...
11. **CRITICAL: tokensZh CONSISTENCY REQUIREMENTS:**
    ...
    - If input text is Chinese (langDisplay = "zh"):
      ...
      2) zhSentence MUST be identical to displayLine (DO NOT rewrite, DO NOT paraphrase, DO NOT polish, DO NOT reorder words)
      3) tokensZh MUST be generated by word-segmenting zhSentence. When tokensZh are joined (ignoring spaces/punctuation), they MUST exactly reconstruct zhSentence (ignoring spaces/punctuation)
    ` : `
    - If input text is NOT Chinese (e.g., Korean):
      1) displayLine is the original text (e.g., Korean)
